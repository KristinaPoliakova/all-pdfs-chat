...
@pytest.mark.asyncio
async def test_upload_includes_location_header(api_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_pdf_returns_404_for_unknown_id(api_client: AsyncClient) -> None:
    response = await api_client.get(f"/api/v1/pdfs/{uuid.uuid4()}")
...
@pytest.mark.asyncio
async def test_get_pdf_pages_returns_404_for_unknown_id(api_client: AsyncClient) -> None:
    response = await api_client.get(f"/api/v1/pdfs/{uuid.uuid4()}/pages")
